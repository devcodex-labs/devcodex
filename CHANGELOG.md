...
> **最后更新**: 2026-08-03
> **当前未发布**: v1.16.0 已归档；后续未发布实现继续记录到 [`changelogs/unreleased.md`](./changelogs/unreleased.md)。
...
- [`changelogs/releases/v1.16.0.md`](./changelogs/releases/v1.16.0.md) — 最新版本详细变更文档
