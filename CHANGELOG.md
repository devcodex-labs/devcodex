...
> **最新版本详细变更文档**: [`changelogs/releases/v1.18.0.md`](./changelogs/releases/v1.18.0.md)
> **最后更新**: 2026-08-23
> **当前版本**: v1.18.0 将 DevCodex 定位为跨宿主 AI Coding 工程 Harness，修复 Codex progressive SkillRoute 循环，并以 TaskRecoveryStoreV5 把 Hook 状态从事件级 UUID 全快照改为正式任务稳定 A/B；同时交付完成态动作、workspace 本地进化、当前分支优先、ordered cherry-pick、worktree 透明诊断和用户级 immutable runtime generation 的显式收敛。版本发布权威以对应 Git tag、npm registry 与 GitHub Release 为准。
...
| [v1.11.25](./changelogs/releases/v1.11.25.md) | 2026-07-01 | 🔧 **最新 data 吸纳守门与 V68 探针收口**：吸纳数据库记录迁移、前端浏览器验证预算、自验 override、finding 反证矩阵、多阶段关闭、guard 绕过、文档副作用、可执行示例、视觉偏差、一次性脚本、验证副作用、设计帧用途、需求确认前快门和 package/adapter 证据门禁 | [查看](./changelogs/releases/v1.11.25.md) |
| [v1.11.24](./changelogs/releases/v1.11.24.md) | 2026-06-26 | 🔧 **需求输入模板链路与产品完整需求模板收口**：拆分纯新需求、需求变更、Bug 与产品完整需求入口，新增需求方 / 变更 / Bug / 产品模板，固化“产品需求即验收事实源”、Mermaid+文字步骤图、前端交互覆盖和技术验证派生链路 | [查看](./changelogs/releases/v1.11.24.md) |
