...
> **最新版本详细变更文档**: [`changelogs/releases/v1.19.0.md`](./changelogs/releases/v1.19.0.md)
> **最后更新**: 2026-08-26
> **当前版本**: v1.19.0 将真实用户指令、项目/任务绑定、正式产物写入、TaskRecoveryStoreV5 与验证授权收敛到可恢复的单一所有权链；修复需求流程跳过、任务穿插、工具 mutation 绕过、BudgetCard 假绿/重复确认以及事件级 generation 膨胀。版本发布权威以对应 Git tag、npm registry 与 GitHub Release 为准。
