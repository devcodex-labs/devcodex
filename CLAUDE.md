# DevCodex — Claude Code 项目规范

> DevCodex v1.9.x · Claude Code 适配版  
> 本文件由 `devcodex init --claude` 安装到项目根目录，替代 Copilot 的 `.github/instructions/` 注入。
...
*本文件由 DevCodex 管理，请勿手动修改。升级请运行 `devcodex update --claude`。*
