...
> **用途**: 记录尚未正式发版的实现级变更。
> **当前**: v1.16.7 已形成发布候选并归档到 `changelogs/releases/v1.16.7.md`；本文件保留候选索引与历史镜像供 validate 探针消费，远端发布事实仍以 tag、npm registry 和最终回读为准。v1.16.6 及更早版本的已发布事实保持历史不变。
