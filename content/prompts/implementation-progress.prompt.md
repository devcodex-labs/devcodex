...
| VisibleOutputContract | entry/completion/confirmation/progress/final/error 或文件交付 | PASS/🔄/N/A | manifestId / reconciliation / visibleSetId / listed+remaining=total / requiredHidden / semanticDigest / rendererTier / ArtifactDeliveryAttemptV1 actionStatus+readback+fallback |
| HostContractVerification | Hook / CLI / visible envelope / sticky project / workspace guard / bootstrap / LinkCapability / MCP fallback / local observability | ✅/🔄/N/A | hostSurface / presentationSurface / eventScope / evidenceMode / visibleReplyEvidence / workspaceGuard / bootstrapScope / capabilityEvidence / rendererParity / actionId / readback / mcpFallback / localProbe / checkpointValidation / localTaskTrace |
