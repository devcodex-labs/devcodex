...
> ⚠️ 分布式系统、性能工程、隐私合规或 AI 评测语义分别触发 `distributed-systems-architecture`、`performance-engineering`、`privacy-compliance-architecture`、`ai-evaluation-engineering`，并把对应 owner 字段与验证写入批次计划。
