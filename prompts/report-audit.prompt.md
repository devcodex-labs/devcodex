...
> **Agent**: <agent-id>
> **状态**: 进行中 / 已完成
> **审查目标类型**: 规范文件(D1~D22) / 技术方案(TD-1~TD-13) / 需求文档(RQ-1~RQ-8) / 项目工程(PE-1~PE-11) / 报告(RA-1~RA-6) / 通用文档(DA-1~DA-6)
> **审查范围**: 全面体检 / 定向深度 / 修复验证
...
| # | 级别 | 维度 | 位置 | 问题描述 | 合理性 | 可实施性 | 收益 | 验证状态 | 发现轮次 | 状态 |
|:-:|:----:|------|------|---------|--------|---------|------|:--------:|:-------:|------|
| 1 | 🔴 | G2 | §3.2 | | | | | ✅ 已验证 | R1 | 已修复 |
...
- [ ] 所有 🔴 级问题已解决
- [ ] 所有 🟡 级问题已处理或标注 N/A
- [ ] 达到最少轮次（定向 ≥3 轮连续2轮无新发现；全面体检 ≥3 轮连续3轮无新发现）
