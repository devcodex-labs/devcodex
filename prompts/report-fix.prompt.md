...
| RepairCollaborationContract | ✅ | ✅/⚠️ | lightweight/full、contractState、authorizationEvidence、双层证据；full 的 findingToPatchMap / handoffIntegrity / independentReReview / acceptanceMatrix；模型名称不得作为触发证据 |
| TestRoute | ✅/N/A | ✅/⚠️ | |
