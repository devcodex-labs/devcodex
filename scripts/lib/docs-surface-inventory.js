...
function assertDocsSurfaceInventory (inv) {
  ...
  if (inv.skillDirs !== 84) failures.push(`skills dirs expected 84 got ${inv.skillDirs}`)
  if (inv.pluginSkillIds !== 84) failures.push(`plugin skills expected 84 got ${inv.pluginSkillIds}`)
