...
function runSpecGovernanceBaseSuite(ctx) {
  ...
  const probes = [
    ...
    ['skills/spec-governance/SKILL.md', 'InFlightIssueRequirementBindingGate'],
    ['skills/spec-governance/SKILL.md', 'PI/PF 记录不能替代当前需求修订'],
    ...
    ['skills/dev-default/SKILL.md', '在途缺陷绑定（F-10A）'],
    ['skills/fix-default/SKILL.md', '执行期 CP3 回退'],
    ['skills/fix-default/SKILL.md', 'InFlightIssueRequirementBindingGate'],
    ...
    ['prompts/requirement.prompt.md', 'WorkflowPlanDecisionV1'],
    ['prompts/requirement.prompt.md', '`ceremonyTier`'],
    ['prompts/requirement.prompt.md', '`designDepth`'],
    ['prompts/requirement.prompt.md', '`assuranceLevel`'],
    ...
    ['instructions.md', '`00-需求概况.md` 只保存来源、范围与映射概况'],
    ['instructions.md', '`01-产品需求.md` 保存用户提供的原始产品真相且 AI 不得改写'],
    ['instructions/02-output-paths.instructions.md', '产品模板正文只给产品填写完整 PRD'],
    ['instructions/10-dev.instructions.md', '`00-需求概况.md`（仅来源/映射概况）'],
    ['instructions/10-dev.instructions.md', '原样 `01-产品需求.md`'],
    ['instructions/10-dev.instructions.md', '不改写 01'],
    ...
    ['hooks/_runtime/artifact-slot-registry.v2.json', '01-产品需求.md'],
    ['hooks/_runtime/lifecycle.cjs', 'registryHasTaskArtifact'],
    ['scripts/instruction-fallback-check.js', 'registryHasTaskArtifact'],
    ...
    ['website/docs/intro/index.md', `${skillCount} 个按需触发的工作流技能`],
