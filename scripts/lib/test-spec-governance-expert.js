...
function runSpecGovernanceExpertSuite(ctx) {
  ...
  for (const [file, needle] of [
    ...
    ['skills/test-router/SKILL.md', 'MeasuredVerificationStandard'],
    ['skills/report/SKILL.md', checkV84],
    ['skills/report/SKILL.md', 'MeasuredVerificationStandard'],
    ...
    ['skills/expert-output-quality/SKILL.md', 'MeasuredVerificationStandard'],
    ['instructions/17-compliance.instructions.md', 'MeasuredVerificationStandard'],
    ['instructions.md', 'MeasuredVerificationStandard'],
    ['skills/spec-governance/gate-registry.json', 'measuredVerification'],
    ['prompts/technical-design.prompt.md', 'CodeTruthEvidenceMatrixGate'],
    ['prompts/implementation-plan.prompt.md', 'SolutionFitAgainstRepoGate'],
    ['prompts/report-dev.prompt.md', 'OperationExplanationContractV1'],
