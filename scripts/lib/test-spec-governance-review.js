...
function runSpecGovernanceReviewSuite(ctx) {
  ...
  for (const [file, needle] of [
    ...
    ['skills/report/SKILL.md', 'ExternalReviewClaimVerificationGate'],
    ['skills/audit-report/SKILL.md', 'ExternalReviewClaimVerificationGate'],
    ['skills/spec-governance/gate-registry.json', 'external-review-claim-verification'],
    ['prompts/report-audit.prompt.md', 'ExternalReviewClaimVerification'],
    ['scripts/lib/external-review-claim-verification.js', 'classifyExternalReviewRecapSample'],
    ['scripts/test-external-review-claim-verification.js', 'claim-thin'],
