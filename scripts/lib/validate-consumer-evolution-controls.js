...
function buildConsumerEvolutionControlChecks(ctx) {
  ...
  function checkV95() {
    ...
    if (portfolio.summary.skillCount !== 82 || portfolio.summary.activeSkillCount !== 79 || portfolio.summary.graySkillCount !== 3) {
      err('[V95] portfolio must be 82 skills = 79 active + 3 gray')
    }
