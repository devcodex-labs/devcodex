...
function buildGovernanceControlChecks(ctx) {
  ...
  function checkV24() {
    ...
    const musts = [
      ...
      { file: 'RULES.md', needle: 'Copilot / Claude Code / Codex / Gemini / Grok / Cursor Beta' },
      ...
      { file: 'website/rspress.config.ts', needle: 'Copilot / Claude Code / Codex / Gemini / Grok / Cursor' },
      { file: 'website/docs/index.md', needle: 'Copilot / Claude Code / Codex / Gemini / Grok / Cursor' },
      { file: 'website/docs/index.md', needle: 'Codex' },
      { file: 'website/docs/index.md', needle: 'Hook 能力按宿主/事件降级' },
      { file: 'website/docs/intro/index.md', needle: 'Copilot / Claude Code / Codex / Gemini / Grok / Cursor' },
      ...
      { file: 'package.json', needle: 'Cursor' },
      ...
      { file: 'plugin.json', needle: 'Cursor' },
      ...
      { file: 'skills/user-visible-output-contract/SKILL.md', needle: '六宿主部署副本' },
