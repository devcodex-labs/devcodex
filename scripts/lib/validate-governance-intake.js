...
function buildGovernanceIntakeChecks(ctx) {
  ...
  function checkV44() {
    const probes = [
      ...
      { file: 'skills/test-router/SKILL.md', needles: ['regressionChecks', '历史能力、必跑验证、对应批次和失败回滚点', 'strict-descendant-same-scope', 'strict-descendant-exact-scope-current-auto-rebind', 'auto-root-rollover-scope-changed', 'parentRootReceiptDigest + parentTerminalDigest'] },
      { file: 'scripts/run-validation.js', needles: ['assessAutoRootRollover', 'isSameSet', 'assertRootReplacementSafe', 'auto-root-rollover-plan-only', 'auto-root-rollover-authorized', 'auto-root-rollover-scope-changed', 'candidateBinding(candidate)'] },
