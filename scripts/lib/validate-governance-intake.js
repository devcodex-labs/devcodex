...
function buildGovernanceIntakeChecks(ctx) {
  ...
  function checkV44() {
    const probes = [
      ...
      { file: 'scripts/test-validation-budget-control.js', needles: ['validation-budget-root-rollover-session', 'live-root-replacement', 'server-owned store must reject direct live root replacement', 'root-rollover-widened', 'auto-root-rollover-plan-only', 'auto-root-rollover-authorized', 'rootRolloverReason'] },
