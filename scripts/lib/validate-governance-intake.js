...
function buildGovernanceIntakeChecks(ctx) {
  ...
  function checkV41() {
    const probes = [
      ...
      { file: 'instructions/10-dev.instructions.md', needles: ['SimpleTaskFastPath（简单任务轻路径）', '在 mutation 前撤销轻路径并升级回完整 CP/产物链', '禁止先写再升级', '00-需求变更概况.md', 'ExistingRequirementArtifactOverride', 'ArtifactLifecycleState'] },
  ...
  function checkV44() {
    const probes = [
      ...
      { file: 'skills/test-router/SKILL.md', needles: ['regressionChecks', '历史能力、必跑验证、对应批次和失败回滚点', 'committed-repair-diff', 'strict-descendant-same-scope', 'strict-descendant-exact-scope-current-auto-rebind', 'auto-root-rollover-scope-changed', 'parentRootReceiptDigest + parentTerminalDigest'] },
      { file: 'scripts/run-validation.js', needles: ['assessAutoRootRollover', 'committedRepairProof', 'ValidationCommittedRepairFootprintV1', 'isSameSet', 'assertRootReplacementSafe', 'auto-root-rollover-plan-only', 'auto-root-rollover-authorized', 'auto-root-rollover-scope-changed', 'candidateBinding(candidate)'] },
      { file: 'scripts/lib/validation-evidence-store.js', needles: ['a live validation lease or runner must reach a durable terminal state before root replacement'] },
      { file: 'scripts/test-validation-budget-control.js', needles: ['validation-budget-root-rollover-session', 'validation-budget-committed-repair-session', 'live-root-replacement', 'server-owned store must reject direct live root replacement', 'root-rollover-widened', 'root-rollover-narrowed', 'root-rebind-current', 'root-rollover-completed-child', 'auto-root-rollover-plan-only', 'auto-root-rollover-authorized', 'rootRolloverReason'] },
      { file: 'hooks/_runtime/lifecycle.cjs', needles: ['CP3_RUNTIME_FILE_THRESHOLD', 'cp-gate-CP3-runtime-threshold', '执行中已触达'] },
      { file: 'scripts/test-hooks-runtime.js', needles: ['ownerBackedRuntimeThresholdTargets', 'cp-gate-CP3-runtime-threshold', 'owner-backed runtime threshold should not warn before the 5th unique source file', 'owner-backed runtime threshold must warn on the 5th unique source file', 'denied ownerless writes must not advance CP3 runtime tracking'] },
      { file: 'hooks/_runtime/task-recovery-store-v5.cjs', needles: ['trackedFileDigests', 'cp3Runtime', 'mutation-preflight'] },
  ...
  function checkV51() {
    const probes = [
      { file: 'instructions.md', needles: ['ArtifactDeliveryManifestV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'ArtifactDeliveryAttemptV1', 'mcpFallback=used', 'invoke'] },
      { file: 'instructions/01-common.instructions.md', needles: ['UserFacingArtifactSetV1', 'mcpFallback=used', 'MCP bridge'] },
      { file: 'instructions/02-output-paths.instructions.md', needles: ['LinkCapabilityDecision 客户端兼容矩阵', 'HostLinkCapabilityDecisionV2', 'ArtifactDeliveryAttemptV1', 'presentationSurface', 'actionStatus', 'readback', '`clickable`', '`portable`', '`failed`', 'MCP profile fallback', '禁止只输出裸文件名'] },
      { file: 'instructions/16-report.instructions.md', needles: ['ArtifactDeliveryManifestV1', 'UserFacingArtifactSetV1', '绝对路径 fallback'] },
      { file: 'instructions/17-compliance.instructions.md', needles: ['ArtifactDeliveryManifestV1', 'UserFacingArtifactSetV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'ArtifactDeliveryAttemptV1'] },
      { file: 'skills/host-contract-verification/SKILL.md', needles: ['artifactLinkMatrix', 'VisibleOutputHostEvidenceGate', 'HostPermissionAuthorityInvariant', 'presentationSurface', 'mcpFallback', 'Cannot read properties of undefined'] },
      ...
      { file: 'skills/compliance/SKILL.md', needles: ['ArtifactDeliveryManifestV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'ArtifactDeliveryAttemptV1', 'HostPermissionAuthorityInvariant'] },
      ...
      { file: 'prompts/report-dev.prompt.md', needles: ['PostCompletionActionSetV1', 'EntryCheckModelV3', 'DevCodexVisibleEnvelopeV3.semanticDigest', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'ArtifactDeliveryAttemptV1', 'presentationSurface', 'readback'] },
      ...
      { file: 'website/docs/guide/development.md', needles: ['DevCodexVisibleEnvelopeV3', 'mcpFallback=used'] },
