...
function buildGovernanceIntakeChecks(ctx) {
  ...
  function checkV51() {
    const probes = [
      { file: 'instructions.md', needles: ['ArtifactDeliveryManifestV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'mcpFallback=used', 'invoke'] },
      { file: 'instructions/01-common.instructions.md', needles: ['UserFacingArtifactSetV1', 'mcpFallback=used', 'MCP bridge'] },
      { file: 'instructions/02-output-paths.instructions.md', needles: ['LinkCapabilityDecision 客户端兼容矩阵', 'HostLinkCapabilityDecisionV2', 'presentationSurface', '`clickable`', '`portable`', '`failed`', 'MCP profile fallback', '禁止只输出裸文件名'] },
      { file: 'instructions/16-report.instructions.md', needles: ['ArtifactDeliveryManifestV1', 'UserFacingArtifactSetV1', '绝对路径 fallback'] },
      { file: 'instructions/17-compliance.instructions.md', needles: ['ArtifactDeliveryManifestV1', 'UserFacingArtifactSetV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2'] },
      ...
      { file: 'skills/compliance/SKILL.md', needles: ['ArtifactDeliveryManifestV1', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'HostPermissionAuthorityInvariant'] },
      ...
      { file: 'prompts/report-dev.prompt.md', needles: ['PostCompletionActionSetV1', 'DevCodexVisibleEnvelopeV2.semanticDigest', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'presentationSurface'] },
