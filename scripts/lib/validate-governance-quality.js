...
function buildGovernanceQualityChecks(ctx) {
  ...
  function checkV71() {
    ...
    const probes = [
      ...
      { file: 'website/docs/index.md', needles: ['76 个 Skills'] },
      { file: 'website/docs/intro/index.md', needles: ['76 个按需触发的工作流技能', 'user-manual-authoring', 'review-checklist'] },
      { file: 'website/docs/specs/directory-structure.md', needles: ['扁平一级 Skill（76 个）', 'user-manual-authoring', 'review-checklist'] },
  ...
  function checkV73() {
    ...
    const probes = [
      ...
      { file: 'README.md', needles: ['ConfirmedAbsorptionCompletenessGates', 'evolution-governance', '76 个'] },
      { file: 'website/docs/index.md', needles: ['76 个 Skills'] },
      { file: 'website/docs/intro/index.md', needles: ['76 个按需触发的工作流技能', 'evolution-governance'] },
      { file: 'website/docs/specs/directory-structure.md', needles: ['扁平一级 Skill（76 个）', 'evolution-governance'] },
