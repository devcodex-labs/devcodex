...
function buildOptimizationControlChecks(ctx) {
  ...
  function checkV92() {
    ...
    if (portfolio.summary.skillCount !== 83) err(`[V92] expected 83 skills, got ${portfolio.summary.skillCount}`)
    ...
    if (portfolio.summary.operationalEvidenceCompleteCount !== 83) err('[V92] operational lifecycle evidence is incomplete')
    ...
    console.log(`[V92] optimization controls checked: skills=83 gray=3 runtimeAlerts=${runtimeState.summary.alertCount}`)
  }
