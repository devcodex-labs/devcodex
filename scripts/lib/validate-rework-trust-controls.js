...
function buildReworkTrustControlChecks(ctx) {
  ...
  function checkV94() {
    ...
    const required = [
      ...
      ['skills/user-visible-output-contract/SKILL.md', ['ArtifactDeliveryManifestGate', 'UserFacingArtifactProjectionGate', 'PostCompletionActionSetV1', 'DevCodexVisibleEnvelopeV2', 'LinkCapabilityDecisionV1', 'HostLinkCapabilityDecisionV2', 'presentationSurface']],
      ['skills/host-contract-verification/SKILL.md', ['VisibleOutputHostEvidenceGate', 'HostPermissionAuthorityInvariant', 'presentationSurface', 'verified-missing', 'unverified']],
