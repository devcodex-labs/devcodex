...
function buildReworkTrustControlChecks(ctx) {
  ...
  function checkV94() {
    ...
    const required = [
      ...
      ['skills/user-visible-output-contract/SKILL.md', ['ArtifactDeliveryManifestGate', 'UserFacingArtifactProjectionGate', 'PostCompletionActionSetV1', 'DevCodexVisibleEnvelopeV2', 'LinkCapabilityDecisionV1']],
