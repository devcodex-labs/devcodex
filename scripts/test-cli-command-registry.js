...
assert.strictEqual(runCliCommand({ cmd: 'uninstall', argv: [], registry, runMigrateLayout: migrate, process: fakeProcess, c, console: logger }), 'CLI_HOST_CONFIG_GLOBAL_ONLY')
assert.deepStrictEqual(calls.pop(), ['cmdUninstallHost', 'all', []])
