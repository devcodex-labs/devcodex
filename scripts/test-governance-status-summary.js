...
try {
  ...
  assert.strictEqual(summary.alwaysOn.schemaVersion, 'AlwaysOnGovernanceSummaryV1')
  assert.strictEqual(summary.alwaysOn.readOnly, true)
  assert.strictEqual(summary.alwaysOn.defaultBehaviorChanged, false)
  assert.strictEqual(summary.alwaysOn.ao3Enabled, false)
  assert.ok(summary.alwaysOn.surfaceMatrix.sourceApplyToFiles >= 15)
  assert.strictEqual(summary.alwaysOn.hostMatrix.grokModeCount, 3)
  assert.strictEqual(summary.alwaysOn.layerMatrix.l0MandatoryCount, summary.alwaysOn.layerMatrix.mandatoryRuleCount)
  assert.strictEqual(summary.alwaysOn.shadow.sampleCount, 40)
  assert.strictEqual(summary.alwaysOn.shadow.p0MissedCount, 0)
