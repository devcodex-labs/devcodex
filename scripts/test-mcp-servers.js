...
function testMemoryProjectionQueriesAndZeroWrite() {
  ...
  assert.strictEqual(status.summaryCurrentProjection.schemaVersion, 'MemorySummaryCurrentProjectionStatsV1')
  assert.strictEqual(status.summaryCurrentProjection.currentActiveRowCount, status.activeSessionIds.length)
  assert.ok(status.summaryCurrentProjection.historicalActiveRowCount >= 1)
