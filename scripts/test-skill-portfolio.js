...
assert.strictEqual(first.summary.skillCount, 80)
assert.strictEqual(first.schemaVersion, 2)
assert.strictEqual(first.summary.registeredSkillCount, 80)
assert.strictEqual(first.summary.activeSkillCount, 77)
...
assert.strictEqual(first.summary.conflictReviewedCount, 80)
assert.strictEqual(first.summary.operationalEvidenceCompleteCount, 80)
