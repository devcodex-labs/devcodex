...
assert.strictEqual(first.summary.skillCount, 83)
assert.strictEqual(first.schemaVersion, 2)
assert.strictEqual(first.summary.registeredSkillCount, 83)
assert.strictEqual(first.summary.activeSkillCount, 80)
