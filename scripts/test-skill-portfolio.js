...
assert.strictEqual(first.summary.skillCount, 85)
assert.strictEqual(first.schemaVersion, 2)
assert.strictEqual(first.summary.registeredSkillCount, 85)
assert.strictEqual(first.summary.activeSkillCount, 82)
...
assert.strictEqual(first.summary.dependencyCycleCount, 0)
assert.strictEqual(first.summary.conflictReviewedCount, 85)
assert.strictEqual(first.summary.operationalEvidenceCompleteCount, 85)
