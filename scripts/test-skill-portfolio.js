...
assert.strictEqual(first.summary.skillCount, 84)
assert.strictEqual(first.schemaVersion, 2)
assert.strictEqual(first.summary.registeredSkillCount, 84)
assert.strictEqual(first.summary.activeSkillCount, 81)
...
assert.strictEqual(first.summary.dependencyCycleCount, 0)
assert.strictEqual(first.summary.conflictReviewedCount, 84)
assert.strictEqual(first.summary.operationalEvidenceCompleteCount, 84)
