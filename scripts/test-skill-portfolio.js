...
assert.strictEqual(first.summary.skillCount, 81)
assert.strictEqual(first.schemaVersion, 2)
assert.strictEqual(first.summary.registeredSkillCount, 81)
assert.strictEqual(first.summary.activeSkillCount, 78)
...
assert.strictEqual(first.summary.conflictReviewedCount, 81)
assert.strictEqual(first.summary.operationalEvidenceCompleteCount, 81)
