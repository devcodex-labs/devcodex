...
assert.match(codexDesktopRendered, /\| 检查项 \| 状态 \| 结论 \|/)
assert.match(codexDesktopRendered, /\|---\|---\|---\|/)
assert.match(codexDesktopRendered, /\| PC0 中断处理 \| `PASS` \|/)
assert.match(codexDesktopRendered, /\| PC5 本轮范围 \| `WARN` \|/)
