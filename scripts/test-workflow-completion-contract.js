...
inspectMutation(files => { files['README.md'] = files['README.md'].split('npm run global-adapters:apply').join('') }, 'completion-public-consumer-drift:README.md:PublicReadmeContractV1:npm run global-adapters:apply')
inspectMutation(files => {
