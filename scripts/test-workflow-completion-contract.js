...
inspectMutation(files => { files['README.md'] = files['README.md'].split('extensions.devcodex.workflowCompletion.mode').join('extensions.devcodex.completion.mode') }, 'completion-public-consumer-drift:README.md:extensions.devcodex.workflowCompletion.mode')
inspectMutation(files => {
