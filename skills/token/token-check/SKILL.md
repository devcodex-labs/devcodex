---
name: Token Check
description: Token 授权验证规范 — Free/Pro/Enterprise 三层授权 + 功能门控
---
# Token Check Skill
...
| 层级 | 标识 | 开放功能 |
|------|------|---------|
| Free | 无 Token | 基础开发/修复/分析/聊天工作流 |
| Pro | `DEVCODEX_TOKEN=pro_*` | + 数据库/优化/场景测试/安全修复/项目审查/影响评估/API验证 |
...
| fix-default / analyze-research / audit-common / chat | ✅ | ✅ | ✅ |
